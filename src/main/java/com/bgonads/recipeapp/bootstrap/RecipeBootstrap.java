package com.bgonads.recipeapp.bootstrap;

import com.bgonads.recipeapp.models.*;
import com.bgonads.recipeapp.repositories.CategoryRepository;
import com.bgonads.recipeapp.repositories.RecipeRepository;
import com.bgonads.recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("The recipes have been saved.");
    }
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp removed and chopped",new BigDecimal(.5), eachUom));
        ...
        tacoRecipe.addIngredient(new Ingredient("freshly grated orange zest",new BigDecimal(1), tableSpoonUom));
        tacoRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp removed and chopped",new BigDecimal(.5), eachUom));
